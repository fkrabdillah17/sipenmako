            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-10">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="/datum/simpan" method="post" enctype="multipart/form-data">
                                <?= csrf_field(); ?>
                                <div class="form-group row">
                                    <label for="namapemilik" class="col-sm-4 col-form-label">Nama Pemilik Proyek</label>
                                    <div class="col-sm-8 ">
                                        <input type="text" class="form-control <?= ($validation->hasError('namapemilik')) ? 'is-invalid' : ''; ?>" id="namapemilik" name="namapemilik" autofocus value="<?= old('namapemilik') ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="namaproyek" name="namaproyek" value="<?= old('namaproyek') ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="lokasiproyek" class="col-sm-4 col-form-label">Lokasi</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="lokasiproyek" name="lokasiproyek" value="<?= old('lokasiproyek') ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="ruasjalan" class="col-sm-4 col-form-label">Ruas Jalan</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="ruasjalan" name="ruasjalan" value="<?= old('ruasjalan') ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="sumberdana" class="col-sm-4 col-form-label">Sumber Dana</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="sumberdana" name="sumberdana" value="<?= old('sumberdana') ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="nokontrak" class="col-sm-4 col-form-label">No. Kontrak</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="nokontrak" name="nokontrak" value="<?= old('nokontrak') ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="tglmulai" class="col-sm-4 col-form-label">Tanggal Mulai</label>
                                    <div class="col-sm-8">
                                        <input type="date" class="form-control" id="tglmulai" name="tglmulai" value="<?= old('tglmulai') ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="tglselesai" class="col-sm-4 col-form-label">Tanggal selesai</label>
                                    <div class="col-sm-8">
                                        <input type="date" class="form-control" id="tglselesai" name="tglselesai" value="<?= old('tglselesai') ?>">
                                    </div>
                                </div>
