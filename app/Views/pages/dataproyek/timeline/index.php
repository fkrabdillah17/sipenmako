            ...
            <div class="container-fluid">
                        ...
                        <form action="/timeline/index" method="post">
                            <div class="input-group p-3">
                                <select class="custom-select" id="cari_proyek" aria-label="Example select with button addon" name="cari_proyek">
                                    <option value="<?= old('cari_proyek'); ?>"><?= (old('cari_proyek')) ? old('cari_proyek') : '--Pilih Proyek--' ?></option>
                ...
                <div class="card text-center">
                    <div class="card-footer">
                        <a href="/timeline/grafik" type="button" class="btn btn-primary">Lihat Grafik</a>
                    </div>
                </div>
