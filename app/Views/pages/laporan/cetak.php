...
<div id="content">
    <div class="container-fluid">
        ...
        <h4 style="text-align:center" class="m-0 font-weight-bold">Laporan <?= $laporan; ?> Proyek</h4>
        <h4 style="text-align:center" class="m-0 font-weight-bold">Tahun <?= $tahun_laporan; ?> </h4>

        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered" width="100%" cellspacing="0">
                    <?php if ($laporan == 'Kecelakaan Kerja') { ?>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($kecelakaan as $data) : ?>
                                ...
                                <?php if (date('Y', strtotime($data['tgl'])) == $tahun_laporan) { ?>
                                    <?php if ($data['namaproyek'] !== $judul) { ?>
                                        <tr>
                                            <th colspan="6" class="text-center"><?= $data['namaproyek']; ?></th>
                                        </tr>
                                        <tr>
                    ...
                    <?php } elseif ($laporan == 'Progres') { ?>
                        ...
                        <tbody>
                            <?php foreach ($progres as $data) : ?>
                                <?php if (date('Y', strtotime($data['tglmulai'])) == $tahun_laporan) { ?>
                                    <tr>
                                        <td><?= $data['noitem']; ?></td>
                                        <td><?= $data['keterangan']; ?></td>
                                        <td><?= $data['tglmulai']; ?></td>
                    ...
                    <?php } else { ?>
                        ...
                        <?php foreach ($proyek as $p) : ?>
                            <?php if (date('Y', strtotime($p['tglmulai'])) == $tahun_laporan) { ?>
                                <?php
                                ...
                                <div class="py-3">
                                    <table class="table table-bordered" width="100%" id="timeline" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th style="text-align: center;" colspan="14">Timeline Proyek <?= $p['namaproyek']; ?></th>
                                            </tr>
                                            <tr>
